...
class Slide extends Model {
	...
	public $identicals;
        ...
        public $wasTranslatedFromRevision;
	...
	public function getDescription() {
		$res = $this->dbGetOne('SELECT description FROM slide WHERE id=:id', array ('id' => $this->slide_id ));
...
//        }
        ...
        public function getWasTranslatedFromRevision(){
            $this->initConnection();
            $translated_from = $this->dbGetOne('SELECT translated_from_revision FROM slide WHERE id=:id',array('id' => $this->slide_id));
            return $translated_from;
        }
