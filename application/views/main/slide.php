...
<script src="libraries/frontend/deck.js/extensions/codemirror/deck.codemirror.js"></script>
    ...
    <?php	if( is_array($usage) && count($usage) ){ ?>
        <div class="breadcrumb" style="z-index:10;padding-left:15px;">
            <?php echo _("<b>This slide is part of the following presentations:</b><br/>");?>
    ...
    <?php }elseif($slide->last_revision_id!=$slide->id){?>
        ...
        <?php echo _('<small>*There are new revisions of this slide.'); 
        echo '<a href="slide/' . $slide->last_revision_id . '">'; 
        echo _('Go to the latest revision of this slide!</a></small>');?>
        </div>	
    <?php }?>
                    
     <ul class="tabs" data-tabs="tabs">
        <li class="active" id="slide_content"><a href="#content">Slide</a></li>
        <li id="slide_comments"><a href="#comments" >
                <?php echo _('Comments'); echo '(' . count($slide->comments) . ')';?>
        </a></li>                            
    </ul>
            ...
            <div class="slide">
                <div class="slide-content">
                    ...
                    <div class="slide-metadata">
                        <?php if( $slide->note): ?>
                            <div id="slide-note" >
                            <? echo _('*Speaker notes:'); echo $slide->note; ?>
                            <br></div>
                        <?php endif;?>
                    </div>
                </div>	
    ...
    <?php if( $slide->description): ?>
            <? echo _('Original Source:'); ?>
            <a><?php echo $slide->description; ?></a><br/>
    <?php endif;?>
    <? echo _('Created by'); ?>
    <a href="user/<?php echo $slide->owner->id; ?>">
    <?php echo $slide->owner->username; ?></a>.
