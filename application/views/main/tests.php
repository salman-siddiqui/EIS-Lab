...
<form class="form-stacked" id="quest_preferences">
    <fieldset>
        <?php if ($type=='manual' || $type=='user') :?>
            <legend><? echo _('Set your preferences'); ?></legend>
            <div class="clearfix">
                <div data-alert="alert" class="alert alert-block alert-error" style="display:none">
                    <div class="input" style="margin-top:5px">
                        ...
                        <select name="test_type" onchange="loadTestsByType(this.value, <?php echo $id; ?>)">
                            <option value="manual" <?php if ($type=='manual') echo 'selected'; ?>><? echo _("User's test"); ?></option>
                            <option value="user" <?php if ($type=='user') echo 'selected'; ?>><? echo _('Own test'); ?></option>
                        </select>
                    </div>                    
                </div>
                <div data-alert="alert" id="testDiv" class="alert alert-block alert-info" style="display:<?php if ($type=='') echo 'none'; else echo 'block';?>">
                    <div style="float:left" id="choose_manual">
                        <legend><? echo _('Choose a test:'); ?></legend>
                        ...
                        <div id="only_user_div" style="float:left; margin-top:10px; padding-right: 10px;">
                            <label>
                                ...
                                <span><? echo _('Show only my tests'); ?></span>
                            </label>
                        </div>
                    </div>
                    <div id="attention_manual" style="display:none; float:left">
                        <? echo _('There are no tests for the chosen preferences.'); ?>
                    </div>                    
                    <div>
            ...
            <?php else : ?>
                <legend><? echo _('Set your preferences for the') . $title . _('test'); ?></legend>
                <div class="clearfix">
                    <div data-alert="alert" class="alert alert-block alert-error" style="display:none;">
                        <div class="input" style="margin-top:5px">
                            <select name="test_type">
                                <option value="auto" <?php if ($type=='auto' || $type=='') echo 'selected'; ?>><? echo _('Automatic test'); ?></option>
                                <option value="exam" <?php if ($type=='exam') echo 'selected'; ?>><? echo _('Exam mode'); ?></option>
                            </select>
                        </div>
                    </div>                    
            ...
            <?php endif;?>
                    <div data-alert="alert" id="modeDiv" class="alert alert-block" style="display:<?php if ($type=='' || $id<=0) echo 'none'; else echo 'block';?>">
                            ...
                            <div class="input">
                                <label>
                                    ...
                                    <span><? echo _('random: you will be asked to answer the questions from all the modules of the chosen course in random order.'); ?></span>
                                </label>
                                <label>
                                    <input type="radio" name="mode" value="2">
                                    <span><? echo _('increase difficulty: you will be asked to answer the questions from all the modules of the chosen course in order of increasing difficulty'); ?></span>
                                </label>
                                <label>
                                    <input type="radio" name="mode" value="3">
                                    <span><? echo _('only difficult: you will be asked to answer only the questions with more than average difficulty from all the modules in random order'); ?></span>
                                </label>
                            </div>
                    ...
                    <div data-alert="alert" id="limitDiv" class="alert alert-block alert-success" style="display:<?php if ($type=='' || $id<=0) echo 'none'; else echo 'block';?>">
                        ...
                        <legend><? echo _('Set up the maximal number of questions from each module:'); ?></legend>
                        <div class="input" style="margin-top:5px">
...
<?php else:?>
    <div><? echo _('Please, Login or Register for taking a test!'); ?></div>
<?php endif; ?>
