...
<?php if ($user['is_authorized']){ ?>
    ...
    <?php if($response==1){?>
        <div class="alert-message fade in success" data-alert="alert">
            ...
            <p>
                <? echo _('Style was successfully saved!'); ?> ---> 
                <a href=deck/<?php echo $deck->id;?>/style/<?php echo $styleObj->id; ?>>
                    <b><? echo _('Go back to'); echo $deck->title;?>".</b>
                </a>
            </p>
        </div>	
    <?php }?>	
    ...
    <div class="content">
        <div class="page-header">
            <h1>
                <a href="deck/<?php echo $deck->id . '_' . $deck->slug_title; ?>">
                    <?php echo $deck->title; ?>
                </a>
                : <? echo _('Edit Theme'); ?> / 
                <a href="./?url=transition/builder4impress&deck=<?php echo $deck->id;?>">
                    Builder4Impress
                </a>
                <span align="right" id="go_impress"> / <a href="./?url=transition/impressionist&deck=<?php echo $deck->id;?>">Impressionist</a></span>
            </h1>
        </div>
        <form method="post" action="./?url=main/changeStyle">
            ...
            <div class="clearfix">
                <label for="theme:"><? echo _('Theme:'); ?></label>
                <div class="input">
        ...
        <form method="post" action="./?url=main/changeStyle">
            ...
            <div class="clearfix">
                <label for="style:"><? echo _('Style:'); ?></label>
                ...
                <div class="input">
                    ...
                    <div class="tab-content">
                        <div id="scsstab" class="active">
                            <b><? echo _('Mixins and Variables'); ?></b> 
                            (<? echo _('For more info go <a href="http://sass-lang.com/" target="_blank">here</a>'); ?>
            ...
            <div class="clearfix">
                <label for="name:"><? echo _('Name:'); ?></label>
            ...
            <div class="clearfix">
                <label for="comment:"><? echo _('Comment:'); ?></label>
    ...
    <div id="slide-area" class="deck-container" style="min-height:850px">
        ...
        <form action="." method="get" class="goto-form">
            <label for="goto-slide"><? echo _('Go to slide:'); ?></label>
