...
<tr>
<td class="new-item"><?php echo _('New item or revision added.'); ?></td>
<td class="removed-item"><?php echo _('Item deleted.'); ?></td>
<td class="modified-item"><?php echo _('Position of the item changed!'); ?></td>
</tr>
</table>
</div>
<table>
	<tr>
		<td>
		<div><b><?php echo _('The deck was translated from this revision:'); ?></b><br>
		<div id="old_tree" class="with-scroll-modal"></div>
		</div>
		</td>
		<td>
		<div><b><?php echo _('There is the last revision of source deck:'); ?></b><br>
	...
	<tr>
		<td colspan="2">
		<center>
                    <a class="btn" onclick="compare_decks()"> <?php echo _('Compare Decks'); ?> </a> 
                    <a class="btn info" onclick="compare_selected_slides()"> <?php echo _('Compare Selected Slides'); ?> </a>
                    <a class="btn error" onclick='updateTranslation(<?php echo $last_id?>, "<?php echo $language_id;?>","<?php echo $language_name;?>" )'> <?php echo _('Update deck')' ?> </a>
                </center>
		</td>
	</tr>
</table>
