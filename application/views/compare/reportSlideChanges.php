...
<title><?php echo _('Slide <?php echo $slide_id;?> diff with previous revision'); ?></title>
...
function compare_slides () {
	...
	diffoutputdiv.appendChild(diffview.buildView({ baseTextLines:base,
												   newTextLines:newtxt,
												   opcodes:opcodes,
												   baseTextName:"<?php echo _('Old Slide'); ?>",
												   newTextName:"<?php echo _('New Slide'); ?>",
...
<td>
<div style="max-width: 50em;"><b><?php echo _('Old Slide:'); ?></b><br><textarea id="old-code-html" name="old-code-html"><?php echo $old_content;?></textarea></div>
</td>
<td>
<div style="max-width: 50em;"><b><?php echo _('New Slide:'); ?></b><br><textarea id="new-code-html" name="new-code-html"><?php echo $new_content;?></textarea></div>
</td>
</tr>
<tr>
<td colspan="2" align="center"> <button onclick="compare_slides()"><?php echo _('Auto Compare'); ?></button> 
	<input type="radio" name="_viewtype" id="sidebyside"/> <?php echo _('Side by Side'); ?>
	&#160;&#160;
	<input type="radio" name="_viewtype" id="inline" checked="checked"/> <?php echo _('Inline'); ?></td>
</tr>
<tr>
<td colspan="2">
	<a name="diff"> </a>
