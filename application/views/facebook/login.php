...
<div id="fb_login_password">
    ...
    <div class="modal-body">
        ...
        <div id="fb_pass" class="clearfix">
            <label for="fb_password"><?php echo _('Choose a SlideWiki password:'); ?></label>
            <div class="input">
                <input type="password" name="fb_password" id="fb_password" class="xlarge" />                        
            </div>
        </div>
        <div id="fb_confirm" class="clearfix">
            <label for="fb_confirmation"><?php echo _('Confirm the password'); ?></label>
            <div class="input">
         ...
         <div class="actions">
            <button type="submit" class="btn primary"><?php echo _('Submit'); ?></button>
        </div>
       </fieldset> 
        </form>
    </div>
