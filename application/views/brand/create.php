...
<?php if($user['is_authorized']): ?>
	<form id="newbrand" action="./?url=brand/create" method="POST">	
		...
		<div class="clearfix">
			<label for="title"><?php echo _("URL"); ?>:</label>
		...
		<div class="clearfix">
			<label for="deck"><?php echo _("Deck ID"); ?>:</label>
...
<?php else: ?>
	<div class="alert-message error">
		<p>
			<?php echo _('<strong>Please <a href="#login-register-modal" data-controls-modal="login-register-modal" data-backdrop="true" data-keyboard="true"><b>Login</b></a> or <a href="#login-register-modal" data-controls-modal="login-register-modal" data-backdrop="true" data-keyboard="true"><b>Register as a new user</b></a>.</strong>
...
<div class="alert alert-block  alert-warning fade in" data-alert="alert">
    <h2><?php echo _("Permission denied!"); ?></h2>
</div>
<?php endif;?>
