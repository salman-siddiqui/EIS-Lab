<?php error_reporting(0);?>
   ...
   <?php REQUIRE_ONCE (ROOT . DS . 'application' . DS . 'library' . DS . 'localisation.php'); //localisation module ?>
...
<script>
  ...
  window.fbAsyncInit = function() {
    FB.init({
      appId      : <?php echo FB_APP; ?>, // App ID
      channelUrl : 'libraries/backend/facebook/channel.html', // Channel File
            ...
            <div class="topbar-inner">
                <div class="container-fluid" id="top-toolbar">
                    ...
                    <form class="form-search pull-left" method="get" id="search_header" onSubmit="return searchSubmitForm(this.keywords.value)">
                        ...
                        <button class="btn small" type="submit"><? echo _("Search"); ?></button>
                    </form>
                    <ul class="nav">
                    <li class="dropdown" style="margin-left:5px;">
                    	<a href="learning-menu" class="dropdown-toggle"><? echo _("About");?></a>
                    	<ul class="dropdown-menu">
                    		<li><a href="documentation/"><? echo _("Documentation"); ?></a></li>
                    		<li><a href="http://blog.aksw.org/category/projects/slidewiki/"><? echo _("News"); ?></a></li>
                    		<li><a href="https://groups.google.com/d/forum/slidewiki"><? echo _("Mailing list"); ?></a></li>
                    		<li><a href="slide/10777/latest"><? echo _("Get involved"); ?></a></li>
                    ...
                    <ul class="nav secondary-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" id="learning-menu">
                                <li><a href="user/<?php echo $user['id']; ?>/scores/"><? echo _("View your scores"); ?></a></li>
                                <li><a id="manage_tests" href="user/<?php echo $user['id']?>/tests/"><? echo _("Manage your tests"); ?></a></li>
<!--                                <li><a href="tests/type/user">Search for test</a></li>-->
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#action-menu" class="dropdown-toggle"><? echo _("Add Deck"); ?></a>
                            <ul class="dropdown-menu" id="user-menu">
                                <li><a href="import/pptx"><? echo _("Upload slides (,pptx)"); ?></a></li>
                                <li><a href="import/html"><? echo _("Upload slides (deck.js, .html)"); ?></a></li>
                                <!-- li><a href="import/latex">Upload slides (.tex)</a></li-->
                                <li><a href="deck/create"><? echo _("Create empty deck"); ?></a></li>
                            </ul>
                        <li class="dropdown">
                            <a href="#user-menu" class="dropdown-toggle"><? echo _("Logged in as") . ' ' . $user['name']; ?></a>
                            <ul class="dropdown-menu" id="user-menu">                                
                                <li><a href="user/<?php echo $user['id']; ?>"><? echo _("Profile"); ?></a></li>
								 <li><a href="./?url=user/badges"><? echo _("Earned Badges"); ?></a></li>
								 <li><a href="#" onClick="window.open('http://localhost/slidewiki/Displayer/Displayer/index.php', '_blank','height=400,width=800')"><? echo _("Import Badges"); ?></a></li>
								 <li><a href="user/feed"><? echo _("News Feed"); ?></a></li>
                                <li><a style="cursor:pointer;" onclick="logout();"><? echo _("Logout"); ?></a></li>
                            </ul>
                        </li>
                        <?php else: ?>
                        <li><a href="#login-register-modal" data-controls-modal="login-register-modal" data-backdrop="true" data-keyboard="true"><? echo _("Login or Register"); ?></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div><!-- /.topbar -->
