...
<?php if($user['is_authorized']): ?>
	<form enctype="multipart/form-data" action="./?url=import/handleOOXMLUpload" method="POST">
		<div class="clearfix">
			<label for="file"><?php echo _('Please choose a file:'); ?></label>
			...
			<div class="input">
				<ul class="inputs-list">
					<li class="row">
						...
						<div class="span10">
							<label>
								<?php echo _('Import with styling'); ?>
							</label>
						</div>
					</li>
				</ul>
...
<?php else: ?>
	<div class="alert-message error">
		<p>
			<?php echo _('<strong>Please <a href="#login-register-modal" data-controls-modal="login-register-modal" data-backdrop="true" data-keyboard="true">Login</a>!</strong>
